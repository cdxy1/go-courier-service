...
const file_internal_proto_orders_proto_rawDesc = "" +
	"\n" +
	"\x1binternal/proto/orders.proto\x12\torders.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"L\n" +
	"\x04Item\x12\x12\n" +
	...
	"\fGetOrderById\x12\x1e.orders.v1.GetOrderByIdRequest\x1a\x1f.orders.v1.GetOrderByIdResponseB?Z=github.com/cdxy1/go-courier-service/internal/protob\x06proto3"

var (
	file_internal_proto_orders_proto_rawDescOnce sync.Once
	file_internal_proto_orders_proto_rawDescData []byte
)

func file_internal_proto_orders_proto_rawDescGZIP() []byte {
	file_internal_proto_orders_proto_rawDescOnce.Do(func() {
		file_internal_proto_orders_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_proto_orders_proto_rawDesc), len(file_internal_proto_orders_proto_rawDesc)))
	})
	return file_internal_proto_orders_proto_rawDescData
}

var file_internal_proto_orders_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_proto_orders_proto_goTypes = []any{
...
func file_internal_proto_orders_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_proto_orders_proto_rawDesc), len(file_internal_proto_orders_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
